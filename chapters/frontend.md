...
La funcionalidad implementada permite gestionar de manera *offline* todo lo referente a tareas, sin embargo no permite por el momento gestionar las demás entidades.Esto quedará pendiente para mejorar en el futuro.
