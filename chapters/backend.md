...
En este capítulo vamos a comenzar analizando el proceso que hemos seguido para el diseño de la *API*, desde aspectos de diseño como el empleo de la Arquitectura *REST* a la elección de las tecnologías empleadas. A continuación describiremos el proceso de implementación del *backend*, donde explicaremos el funcionamiento de las técnologías aplicadas y otras características importantes como los aspectos de seguridad abordados.  
